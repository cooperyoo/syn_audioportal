...
, 							{
								"box" : 								{
									"annotation" : "DelayLength... limit to this is set through creation argument#1",
...
, 							{
								"box" : 								{
									"annotation" : "rate or grain seperation",
									"bgcolor" : [ 0.780392, 0.764706, 0.823529, 1.0 ],
									"bordercolor" : [ 0.941176, 0.941176, 0.941176, 1.0 ],
									"fontname" : "Verdana",
									"fontsize" : 12.0,
...
, 							{
								"box" : 								{
									"annotation" : "choose whether the pisition in bufffer is randomized or scrubed",
...
, 							{
								"box" : 								{
									"annotation" : "slider for srubing position within the buffer",
...
, 							{
								"box" : 								{
									"annotation" : "playback speed (scrubbing of position in buffer)",
...
, 							{
								"box" : 								{
									...
									"annotation" : "live input or external buffer",
...
, 			{
				"box" : 				{
					"align" : 1,
					"annotation" : "somooth/tempered + enable scale and sieves",
...
, 			{
				"box" : 				{
					"annotation" : "discrete pan on/off",
					"disabled" : [ 0 ],
					"id" : "obj-93",
...
, 			{
				"box" : 				{
					"align" : 1,
					"annotation" : "direction of the grains",
					"arrowbgcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"arrowcolor" : [ 0.360784, 0.360784, 0.360784, 1.0 ],
					"arrowframe" : 0,
					"autopopulate" : 1,
...
, 			{
				"box" : 				{
					"annotation" : "number of simultaneaus grains",
